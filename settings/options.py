...
def get_options(option_type):
  ...
  """    
  # name
  tf.app.flags.DEFINE_string("training_name","noaux_noentr_eps_1e-4_noseed","name of next training in log")
  ...
  if option_type == 'training':
    ...
    tf.app.flags.DEFINE_float("aux_initial_learning_rate", 0.0001, "learning rate")
