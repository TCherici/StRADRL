...
def get_options(option_type):
  ...
  if option_type == 'training':
    ...
    # name
    tf.app.flags.DEFINE_string("training_name","maze_3aux_1-4a1-5_lamb09_10hz_vr_rp","name of next training in log")
    ...
    # auxiliary
    tf.app.flags.DEFINE_integer("parallel_size", 3, "parallel thread size")
    ...
    tf.app.flags.DEFINE_integer("experience_history_size", 1000, "experience replay buffer size")
