...
def get_options(option_type):
  ...
  if option_type == 'training':
    tf.app.flags.DEFINE_string("training_name","mazepro_1aux_1e-6","name of next training in log")
    ...
    tf.app.flags.DEFINE_float("initial_learning_rate", 1e-6, "learning rate")
